...
\begin{itemize}
    ...
    \item Proporciona um meio onde programador nao precisa se preocupar com quase nada.
\end{itemize}
...
\begin{itemize}
    ...
    \item São necessárias verdadeiras gambiarras para modificar, por exemplo, o número de threads.
    \item Complicado de se optimizar.
\end{itemize}
